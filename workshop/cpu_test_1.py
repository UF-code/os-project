...
class Ui_Dialog(object):
    ...
    def my_function(self, counter, cpu_, ram_, disk, battery):
        # print(disk)
        disk_percent, disk_used = disk
        # print(disk_percent, disk_used)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ram_label.setText(_translate("Dialog", "CPU_ :"))
...
class ThreadClass(QtCore.QThread):
    ...
    def run(self):
        ...
        while True:
            counter+=1
            # time.sleep(0.01)
            ram_l = psutil.cpu_percent(interval=1, percpu=True)
            ram_ = round(sum(ram_l)/len(ram_l), 2)
